...
/* 实现电机转动的编码器计数, 用于计算速率和距禄1�7
 * 电机编码器是AB信号的形弄1�7, 当A信号领先B信号旄1�7, 脉冲正计敄1�7, 反之脉冲负计敄1�7
 * 由于3861中断棢�测只能在上跳变和下跳变之间二选一, 这里采用中断中改变检测类型设定的方法
 * 实现了上下跳变连续检测的AB脉冲计数.
 *
...
/*
 * iot_gpio.h的极性设置与示波器实测是反的, 重新定义丢�个类垄1�7
 *
